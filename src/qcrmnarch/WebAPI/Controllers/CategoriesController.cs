...
public class CategoriesController : BaseController
{
    ...
    [HttpGet]
    public async Task<ActionResult<GetListResponse<GetListCategoryListItemDto>>> GetList([FromQuery] PageRequest pageRequest, [FromQuery] string searchTerm)
    {
        GetListCategoryQuery query = new() { PageRequest = pageRequest, SearchTerm = searchTerm };
