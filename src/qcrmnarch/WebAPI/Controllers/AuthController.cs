...
public class AuthController : BaseController
{
    ...
    public async Task<ActionResult<GoogleLoginResponse>> GoogleLogin([FromBody] GoogleLoginCommand googleLoginCommand)
    {
        GoogleLoginResponse response = await Mediator.Send(googleLoginCommand);
        return Ok(response);
    }
}
