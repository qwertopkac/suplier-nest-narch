...
builder.Services.AddApplicationServices(
   ...
   tokenOptions: builder.Configuration.GetSection("TokenOptions").Get<NArchitecture.Core.Security.JWT.TokenOptions>()
...
NArchitecture.Core.Security.JWT.TokenOptions tokenOptions =
    builder.Configuration.GetSection(tokenOptionsConfigurationSection).Get<NArchitecture.Core.Security.JWT.TokenOptions>()
